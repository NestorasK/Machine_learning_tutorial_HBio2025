...
glm_preds <- ifelse(glm_probs > 0.5, "Sensitive", "Resistant") %>% factor(levels = levels(y_test))
...
mean_cv_accuracy <- rowMeans(cv_results)
...
model2explain <- h2o.getModel("DRF_1_AutoML_2_20250428_162846")
